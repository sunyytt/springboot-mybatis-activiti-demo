...
import com.example.demo.redis.cache.CacheTime;
import com.example.demo.redis.cache.CustomizedRedisCacheManager;
import com.example.demo.redis.serializer.FastJsonRedisSerializer;
import com.example.demo.redis.serializer.StringRedisSerializer;
...
public class RedisConfig {
    ...
    // 查询缓存有效时间
    @Value("${select.cache.timeout:60}")
    private long selectCacheTimeout;
    // 查询缓存自动刷新时间
    @Value("${select.cache.refresh:50}")
