...
import com.example.demo.redis.cache.expression.CacheOperationExpressionEvaluator;
import com.example.demo.redis.utils.RedisTemplateUtils;
import com.example.demo.redis.utils.ReflectionUtils;
import com.example.demo.redis.utils.SpringContextUtils;
...
public class CacheSupportImpl implements CacheSupport {
    ...
    public void refreshCacheByKey(String cacheName, String cacheKey) {
        ...
        System.out.println("执行刷新方法  refreshCacheByKey....................result="+result);
        System.out.println(result instanceof CachedMethodInvocation);
